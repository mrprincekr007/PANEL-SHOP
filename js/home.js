...
function e(e, t, n = 0, s = 600, a = !1) {
        ...
        if (!o) return;
        const r = t % 1 != 0;
        o.innerText = a && window.formatPriceShort ? window.formatPriceShort(t) : r ? t.toFixed(2) : Math.floor(t).toString();
    }
    ...
    function t(e, t = "success") {
        ...
        document.querySelectorAll(".animate-on-view, .stat-card").forEach((e) => {
            e.classList.remove("visible", "animate-fade-up");
    ...
    document.querySelectorAll('.animate-on-view').forEach(el => el.classList.remove('visible'));
